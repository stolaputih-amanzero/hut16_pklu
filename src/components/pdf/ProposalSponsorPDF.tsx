...
export function ProposalSponsorPDF({ data, lang, logoUrl = "/logo_hut16_pklu.png", origin = "https://pklu.amanloka.com" }: Props) {
    ...
    const commitmentMsg = isId
        ? `Halo Panitia HUT 16 PKLU GPIB, saya ingin memberikan komitmen dukungan untuk Proposal Sponsorship No: ${data.number}. Nama saya/lembaga: ${data.name}.`
        : `Hello 16th PKLU GPIB Anniversary Committee, I would like to make a support commitment for Sponsorship Proposal No: ${data.number}. My name/institution is: ${data.name}.`
                        ...
                        <>
                            ...
                            <View style={{ border: '0.5pt dashed #D4AF37', borderRadius: 4, padding: 8, backgroundColor: '#FDFBF7', marginTop: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                ...
                                <View style={{ width: '25%', alignItems: 'center' }}>
                                    <Image src={commitmentWaQrUrl} style={{ width: 65, height: 65, marginBottom: 2 }} />
