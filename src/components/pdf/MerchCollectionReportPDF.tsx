...
const styles = StyleSheet.create({
    ...
    tableColRegCode: { width: '12%', borderStyle: 'solid', borderWidth: 1, borderColor: '#022c22', borderLeftWidth: 0, borderTopWidth: 0 },
    tableColName: { width: '20%', borderStyle: 'solid', borderWidth: 1, borderColor: '#022c22', borderLeftWidth: 0, borderTopWidth: 0 },
    tableColCity: { width: '18%', borderStyle: 'solid', borderWidth: 1, borderColor: '#022c22', borderLeftWidth: 0, borderTopWidth: 0 },
    tableColItems: { width: '20%', borderStyle: 'solid', borderWidth: 1, borderColor: '#022c22', borderLeftWidth: 0, borderTopWidth: 0 },
...
export function MerchCollectionReportPDF({ orders, logoUrl = "/logo_hut16_pklu.png", origin = "https://pklu.amanloka.com", stats }: Props) {
        ...
        <Document>
            <Page size="A4" style={styles.page} orientation="landscape">
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.title}>Laporan Pengambilan Souvenir &amp; Merchandise</Text>
                ...
                {/* Summary Section */}
                <Text style={styles.sectionTitle}>Ringkasan Serah Terima Souvenir</Text>
                <View style={styles.summaryContainer}>
                    <View style={styles.summaryBox}>
                        <View style={styles.summaryRow}>
                            <Text style={styles.summaryLabel}>Total Transaksi Pengambilan</Text>
                            <Text style={styles.summaryValue}>{stats.orderCount} Transaksi</Text>
                        </View>
                        <View style={styles.summaryRow}>
                            <Text style={styles.summaryLabel}>Total Item Diserahkan (Pcs)</Text>
                            <Text style={[styles.summaryValue, { color: '#047857' }]}>{stats.itemCount} Pcs</Text>
                        </View>
                    </View>
                ...
                <View break>
                    ...
                    <View style={styles.table}>
                        <View style={styles.tableHeaderRow}>
                            ...
                            <View style={styles.tableColName}><Text style={styles.tableCellHeader}>Nama Pembeli</Text></View>
                            <View style={styles.tableColCity}><Text style={styles.tableCellHeader}>Gereja / Kota</Text></View>
                            <View style={styles.tableColItems}><Text style={styles.tableCellHeader}>Tipe Souvenir</Text></View>
                            <View style={styles.tableColQty}><Text style={styles.tableCellHeader}>Qty</Text></View>
                            <View style={styles.tableColTime}><Text style={styles.tableCellHeader}>Waktu Ambil</Text></View>
                        </View>

                        {orders.length === 0 ? (
                            <Text style={styles.emptyState}>Belum ada data pengambilan souvenir.</Text>
                        ) : (
                            orders.map((o: any, idx: number) => {
                                const orderIdStr = `#MB-${o.id.slice(0, 6).toUpperCase()}`
                                const regCodeStr = o.registration_code || '-'
                                const timeStr = o.collected_at 
                                    ? new Date(o.collected_at).toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit', timeZone: 'Asia/Jakarta' }) + ' WIB'
                                    : '-'
                                ...
                                return (
                                    <View style={styles.tableRow} key={o.id || idx}>
                                        ...
                                        <View style={styles.tableColName}><Text style={styles.tableCellBold}>{o.buyer_name}</Text></View>
                                        <View style={styles.tableColCity}><Text style={styles.tableCell}>{o.church_city || '-'}</Text></View>
                                        <View style={styles.tableColItems}><Text style={styles.tableCell}>{o.item_type}</Text></View>
                                        <View style={styles.tableColQty}><Text style={styles.tableCellCenter}>{o.quantity || 1}</Text></View>
                ...
                <View style={styles.footer} wrap={false}>
                    ...
                    <View style={styles.qrBox}>
                        ...
                        <Text style={styles.qrTextBold}>SOUVENIR SELESAI</Text>
